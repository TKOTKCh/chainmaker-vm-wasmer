...
#if defined(WASMER_WASI_ENABLED)
struct wasi_env_t *wasi_env_new(const wasm_store_t *store,struct wasi_config_t *config);
#endif
...
#if defined(WASMER_WASI_ENABLED)
bool wasi_get_unordered_imports(const struct wasi_env_t *wasi_env,
                                const wasm_module_t *module,
...
#if defined(WASMER_COMPILER_ENABLED)
void wasm_config_set_backend(wasm_config_t *config, enum wasmer_backend_t compiler);
#endif
...
#if defined(WASMER_COMPILER_ENABLED)
bool wasmer_is_backend_available(enum wasmer_backend_t compiler);
#endif
